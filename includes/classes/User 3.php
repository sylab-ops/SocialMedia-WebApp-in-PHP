<?php
	class User {
		...
		//Returns all information of the userLoggedIn
		...
		//Method to get number of friend request
		...
		//Method to --> Return number of posts
		...
		// Method to -->First and Last name of the userLoggedIn
		...
		//Method to -->Returns  profile picture
		public function getProfilePic(){
			$username = $this->user['username'];
			$query = mysqli_query($this->con, "SELECT profile_pic FROM users WHERE username ='$username'");
			$row = mysqli_fetch_array($query);
			return $row ['profile_pic']; // Returns profile picture
		}
		...
		public function getFriendArray(){
			...
			$row = mysqli_fetch_array($query);
			return $row ['friend_array']; // Returns friend array
		}
