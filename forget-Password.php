...
// Instantiation and passing `true` enables exceptions
	...
	?>
		<!-- RESET PASSWORD -->
			...
			<form method="POST">
				    	<input type="text" name="email"  placeholder="Email" class="resetPwd"><br>
				    	<input type="submit" name="submit" value="Send Password Reset Link" class="resetPwd">

				    	<!-- Return to Register page -->
				<div class="goBack">
					<center><a href="register.php" target="_top" style="font-weight: bold; margin-bottom: 80px; margin-top: -35px; text-align: center;"><h4 style="">Return to home page</h4></a></center>
				</div>
			</form>
